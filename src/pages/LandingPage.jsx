            ...
            <div className="flex-grow fade-in flex flex-col items-center">
                ...
                <div class="mx-auto max-w-4xl text-center w-[90%] lg:w-full flex flex-col items-center">
                    ...
                    <div className="flex gap-10 m-8">
                        ...
                        <button type="button" onClick={() => navigate("/release_notes")} class="rounded-md bg-white px-6 md:px-8 py-3 md:py-4 text-sm md:text-base font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 animate__animated animate__fadeIn">Release Notes</button>
                    </div>
                </div>
                <h1 className="text-xl font-medium mt-8">Featured Videos</h1>
                <div className="flex flex-col lg:flex-row gap-20 my-8 animate__animated animate__fadeIn items-center">
                    <iframe className="w-[400px] md:w-[560px] h-[250px] md:h-[315px] shadow-lg"
