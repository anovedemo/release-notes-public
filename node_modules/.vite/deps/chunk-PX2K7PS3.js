...
function tokenizeAutolink(effects, ok3, nok) {
  ...
  return start;
  function start(code) {
    ok2(code === codes.lessThan, "expected `<`");
...
function tokenizeCharacterEscape(effects, ok3, nok) {
  return start;
  function start(code) {
    ok2(code === codes.backslash, "expected `\\`");
...
function tokenizeCharacterReference(effects, ok3, nok) {
  ...
  return start;
  function start(code) {
    ok2(code === codes.ampersand, "expected `&`");
...
function tokenizeCodeFenced(effects, ok3, nok) {
  ...
  function atNonLazyBreak(code) {
    ok2(markdownLineEnding(code), "expected eol");
...
function tokenizeCodeText(effects, ok3, nok) {
  ...
  return start;
  function start(code) {
    ok2(code === codes.graveAccent, "expected `` ` ``");
...
function tokenizeContinuation(effects, ok3, nok) {
  ...
  function startLookahead(code) {
    ok2(markdownLineEnding(code), "expected a line ending");
    effects.exit(types.chunkContent);
    effects.enter(types.lineEnding);
    effects.consume(code);
    effects.exit(types.lineEnding);
...
function factoryLabel(effects, ok3, nok, type, markerType, stringType) {
  ...
  return start;
  function start(code) {
    ok2(code === codes.leftSquareBracket, "expected `[`");
    effects.enter(type);
...
function tokenizeHeadingAtx(effects, ok3, nok) {
  ...
  function before(code) {
    ok2(code === codes.numberSign, "expected `#`");
...
function tokenizeLabelEnd(effects, ok3, nok) {
  ...
  return start;
  function start(code) {
    ok2(code === codes.rightSquareBracket, "expected `]`");
    if (!labelStart) {
      return nok(code);
    }
...
function tokenizeResource(effects, ok3, nok) {
  ...
  function resourceStart(code) {
    ok2(code === codes.leftParenthesis, "expected left paren");
...
function tokenizeReferenceFull(effects, ok3, nok) {
  ...
  function referenceFull(code) {
    ok2(code === codes.leftSquareBracket, "expected left bracket");
    return factoryLabel.call(
      self,
      effects,
      referenceFullAfter,
...
function tokenizeLabelStartImage(effects, ok3, nok) {
  ...
  return start;
  function start(code) {
    ok2(code === codes.exclamationMark, "expected `!`");
...
function tokenizeListStart(effects, ok3, nok) {
  ...
  function atMarker(code) {
    ok2(self.containerState, "expected state");
    ok2(code !== codes.eof, "eof (`null`) is not a marker");
...
function resolveToSetextUnderline(events, context) {
  ...
  ok2(text !== void 0, "expected a `text` index to be found");
  ok2(content2 !== void 0, "expected a `text` index to be found");
  const heading = {
...
//# sourceMappingURL=chunk-PX2K7PS3.js.map
